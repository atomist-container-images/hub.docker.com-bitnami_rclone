# Tags: latest, 1.58.1-debian-10-r13, 1.58.1, 1-debian-10, 1
FROM bitnami/rclone:latest
FROM bitnami/rclone:1.58.1-debian-10-r13
...
# Tags: 1.58.1-debian-10-r12
FROM bitnami/rclone:1.58.1-debian-10-r12

# Tags: 1.58.1-debian-10-r11
FROM bitnami/rclone:1.58.1-debian-10-r11

# Tags: 1.58.1-debian-10-r10
FROM bitnami/rclone:1.58.1-debian-10-r10

# Tags: 1.58.1-debian-10-r9
FROM bitnami/rclone:1.58.1-debian-10-r9

# Tags: 1.58.1-debian-10-r8
FROM bitnami/rclone:1.58.1-debian-10-r8

# Tags: 1.58.1-debian-10-r7
FROM bitnami/rclone:1.58.1-debian-10-r7

# Tags: 1.58.1-debian-10-r6
FROM bitnami/rclone:1.58.1-debian-10-r6

# Tags: 1.58.1-debian-10-r5
FROM bitnami/rclone:1.58.1-debian-10-r5

# Tags: 1.58.1-debian-10-r4
FROM bitnami/rclone:1.58.1-debian-10-r4

# Tags: 1.58.1-debian-10-r3
FROM bitnami/rclone:1.58.1-debian-10-r3

# Tags: 1.58.1-debian-10-r2
FROM bitnami/rclone:1.58.1-debian-10-r2

# Tags: 1.58.1-debian-10-r1
FROM bitnami/rclone:1.58.1-debian-10-r1

# Tags: 1.58.1-debian-10-r0
FROM bitnami/rclone:1.58.1-debian-10-r0

# Tags: 1.58.0-debian-10-r31, 1.58.0
